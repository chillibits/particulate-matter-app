...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupPreferencesScreen() {
        ...
        notification_breakdown_number.setSummary(su.getString("notification_breakdown_number", Constants.DEFAULT_MISSING_MEASUREMENT_NUMBER + " " + (Integer.parseInt(su.getString("notification_breakdown_number", String.valueOf(Constants.DEFAULT_MISSING_MEASUREMENT_NUMBER))) > 1 ? res.getString(R.string.measurements) : res.getString(R.string.measurement))));
