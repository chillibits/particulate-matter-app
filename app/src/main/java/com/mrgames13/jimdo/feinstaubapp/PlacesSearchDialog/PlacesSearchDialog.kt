...
class PlacesSearchDialog(private val mContext: Context, private val listener: PlaceSelectedCallback): AppCompatDialog(mContext), PlaceAutocompleteAdapter.PlaceSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Places.initialize(context, context.getString(com.mrgames13.jimdo.feinstaubapp.R.string.maps_api_key))
                    ...
                    placesClient
                            ...
                            .addOnFailureListener {exception ->
                                if(exception is ApiException) {
                                    ...
                                    Log.e("FA", "Place not found: " + apiException.statusCode)
                                }
                                loadingIndicator.visibility = View.GONE
                                recyclerFrame.visibility = View.VISIBLE
                            }
